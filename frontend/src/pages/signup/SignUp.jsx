    ...
    <div className="flex flex-col items-center justify-center min-w-96 mx-auto">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div>
            ...
            <input type="text" placeholder="password" className="w-full input input-bordered h-10" value={inputs.password} 
          ...
          <Link className="text-sm text-blue-500 hover:text-blue-600 mt-2 inline-block" to={"/login"}>Already have an account?</Link> 
